...
**용도**: `google-media` 스킬 — Nano Banana Pro 이미지 + Veo 3.1 영상

**발급**:
1. [ai.google.dev](https://ai.google.dev/) 접속 → Google 계정 로그인
2. "Get API key" → 새 프로젝트 생성 또는 기존 선택
3. **Pay-as-you-go 결제 등록 필수** (Nano Banana Pro/2 및 Veo 3.1은 무료 티어 불가, 2026-02 공지)
4. 생성된 키 복사
...
| **Canva** | AI 생성 이미지 → Canva 템플릿 합성 | `google-media`, `ideogram` |
| **Notion** | 포트폴리오·에셋 라이브러리 관리 | 전체 |
| **YouTube** (선택) | Kling/Veo 숏폼 자동 업로드 | `kling`, `google-media` |
...
- **최종 단계**: Nano Banana Pro (2K/4K), Veo 3.1 Standard, Kling Pro
